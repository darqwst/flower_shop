# Generated by Django 4.2.6 on 2023-12-11 11:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('Тюльпаны', 'Тюльпаны'), ('Розы', 'Розы'), ('Лилии', 'Лилии'), ('Хризантемы', 'Хризантемы'), ('Незабудки', 'Незабудки'), ('Ромашки', 'Ромашки'), ('Георгины', 'Георгины'), ('Пионы', 'Пионы'), ('Орхидеи', 'Орхидеи'), ('Подсолнухи', 'Подсолнухи'), ('Ландыши', 'Ландыши'), ('Астры', 'Астры'), ('Сирень', 'Сирень')], max_length=20)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Тюльпаны', 'Тюльпаны'), ('Розы', 'Розы'), ('Лилии', 'Лилии'), ('Хризантемы', 'Хризантемы'), ('Незабудки', 'Незабудки'), ('Ромашки', 'Ромашки'), ('Георгины', 'Георгины'), ('Пионы', 'Пионы'), ('Орхидеи', 'Орхидеи'), ('Подсолнухи', 'Подсолнухи'), ('Ландыши', 'Ландыши'), ('Астры', 'Астры'), ('Сирень', 'Сирень')], max_length=20)),
            ],
            options={
